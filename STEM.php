...
$objGrid->searchby("InitiativeName");
$objGrid->tabla ("STEM");
$objGrid->keyfield("ProgramID");
$objGrid->datarows(20);
$objGrid->orderby("InitiativeName", "ASC");
$objGrid->FormatColumn("ProgramID", "Program ID", 10, 10, 0, "5", "center", "text");
...
$objGrid->FormatColumn("FundID", "Funding Source", 50, 50, 0, "50", "center", "select:SELECT FundID, EntityShortName FROM FundingSource");
$objGrid->FormatColumn("GrantID", "GrantName", 50, 50, 0, "50", "center", "select:SELECT GrantID, GrantName FROM GrantProgram");
$objGrid->FormatColumn("Relationship", "Relationship", 50, 50, 0, "50", "center", "text");
$objGrid->FormatColumn("FundingAmount", "Initiative Name", 50, 50, 0, "10", "center", "integer");
$objGrid->FormatColumn("StartDate", "Start Date", 50, 50, 0, "50", "center", "date");
$objGrid->FormatColumn("EndDate", "End Date", 50, 50, 0, "50", "center", "date");
